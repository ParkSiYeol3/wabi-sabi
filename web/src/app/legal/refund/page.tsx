...
export default async function RefundPage() {
  ...
  return (
    <LegalPage title="교환·환불 안내" effectiveDate="2026년 7월 13일">
      ...
      <Article heading="4. 청약철회가 제한되는 경우">
      ...
      <Article heading="5. 색상·질감의 개체차">
        <p>
          본 몰에서 판매하는 도자기·유리 등 일부 기물은 소재와 제작 과정의 특성상
          색상·질감·크기·굽의 형태 등에{" "}
          <strong className="text-wabi-fg">개체별 미세한 차이</strong>가 있을 수
          있습니다. 이는 제품의 하자가 아니라 기물 고유의 특성이므로 하자로 인한
          교환·환불 사유에 해당하지 않습니다. 다만 파손·균열 등 명백한 불량은 아래
          &ldquo;6. 불량·오배송&rdquo;에 따라 처리합니다.
        </p>
      </Article>
