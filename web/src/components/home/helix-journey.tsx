...
// 유지하되 loops 를 6→10(밀도↑)·타원비 0.34→0.55(진폭↑)로 올려 겹침을 복원한다
// (데스크톱과 같은 입체감). steps 도 64/loop 로 맞춘다. 극점 좌표(moments)는 각
// 반지름에서 계산해 점·멘트가 곡선에 정확히 맞는다.
const DESKTOP = {
  vb: "0 0 1000 2530",
...
const MOBILE = {
  vb: "0 0 1000 5244",
  geom: helixSegments(500, 175, 230, 0.55, 197, 5047, 10, 640),
  moments: momentPositions(175, 230, 197, 5047, 5244, 10),
