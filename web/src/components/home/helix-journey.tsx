...
// 은은하게(→430). 타원 납작비 0.30. 끝은 캔버스 바닥까지 — 선이 브랜드 로고
// 직전까지 이어진다.
// 8바퀴/캔버스 — 리드인(첫 글씨 위 빈 코일)을 반바퀴로 줄여 곡선이 侘 직전에
// 시작한다(대표님 피드백 — 곡선 길이 단축). 피치·바닥 종점·글씨 간격(7반바퀴)은
// 그대로, 위쪽 2바퀴만 덜어냈다.
const DESKTOP = { vb: "0 0 1000 3310", geom: helixSegments(500, 300, 430, 0.3, 150, 3270, 8, 512) };
const MOBILE = { vb: "0 0 1000 6860", geom: helixSegments(500, 300, 430, 0.3, 311, 6777, 8, 512) };
