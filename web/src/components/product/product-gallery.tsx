...
// 768px 미만에만 적용된다.
const ROW_W = ["w-[88%] md:w-[46%]", "w-[96%] md:w-[64%]"] as const;
...
// 모바일만 다시 올림(#655) — 폭이 138px→155px 로 커졌으니 높이도 따라와야 칸이
// 납작해지지 않는다. sm 이상은 그대로.
const PAIR_H = "h-40 sm:h-48 md:h-64";
