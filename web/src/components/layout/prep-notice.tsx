...
export function PrepNotice({
  ...
  const dialogRef = useModalA11y(open && shouldShow, dismiss);
  ...
  return createPortal(
    ...
    >
      <div
        ...
        className="w-full max-w-sm border border-wabi-border bg-wabi-bg p-7 text-center shadow-xl outline-none"
      >
