...
| 항목 | 브리핑(.md) | 디자인 시안 | 비고 |
|------|------------|------------|------|
| 휴무일 | 일요일 휴무 | **수요일 휴무** | 시안이 최신 → 수요일로 추정, 확인 필요 |
| 주소 | 미기재 | 종로구 필운대로1길 22 2층 | 시안에 실주소 있음 |
| nav 명칭 | Shop/Brand/Auth/Cart/MyPage | Shop/About/Contact(또는 About/Collection/Visit) | 라우팅 명칭 통일 필요 |
